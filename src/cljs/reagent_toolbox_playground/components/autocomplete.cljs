...
(ns reagent-toolbox-playground.components.autocomplete
  (:require [cljs.js :as cljs]
            ...
            [reagent-toolbox.core :refer [autocomplete]]
            [clojure.string :as s]
...
;
(defn view []
  (let [value (ratom/atom "")]
    (fn []
      [:div.article-with-playground
       [:article
        [:h1 "Autocomplete"]
        ...
        [:code
         [display-and-eval-code "
(defn autocomplete-test []
  (let [single-value (ratom/atom \"\")
        multi-value (ratom/atom [])]
   (fn []
     (let [countries [\"Spain\", \"United Kingdom\", \"USA\", \"Thailand\", \"Tongo\", \"Slovenia\"]
       ...
       [:div
         ...
         [rt/autocomplete {:source    countries
                           :value     @single-value
                           :multiple  false
         ...
         [rt/autocomplete {:source    languages
                           :value     @multi-value
                           :multiple  true
